...
#if defined(NDEBUG)
# error "GopnikCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "GopnikCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
		nSubsidy = 15300000 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 1 && pindexBest->nHeight+1 <= 30)	// start 
    {
		nSubsidy = 400 * COIN;
    } 	
	else if(pindexBest->nHeight+1 > 30 && pindexBest->nHeight+1 <= 1440)	// day 1
    {
		nSubsidy = 9000 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 1440 && pindexBest->nHeight+1 <= 2880)  // day 2
    {
		nSubsidy = 8700 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 2880 && pindexBest->nHeight+1 <= 4320) // day 3
    {
		nSubsidy = 7550 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 4320 && pindexBest->nHeight+1 <= 5760) // day 4
    {
		nSubsidy = 6850 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 5760 && pindexBest->nHeight+1 <= 7200) // day 5
    {
		nSubsidy = 5600 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 7200 && pindexBest->nHeight+1 <= 8640) // day 6
    {
		nSubsidy = 4450 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 8640 && pindexBest->nHeight+1 <= 10080) // day 7
    {
		nSubsidy = 3650 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 10080 && pindexBest->nHeight+1 <= 11520) // day 8
    {
		nSubsidy = 3650 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 11520 && pindexBest->nHeight+1 <= 12960) // day 9
    {
		nSubsidy = 2850 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 12960 && pindexBest->nHeight+1 <= 14400) // day 10
    {
		nSubsidy = 2400 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 14400 && pindexBest->nHeight+1 <= 15840) // day 11
    {
		nSubsidy = 2050 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 15840 && pindexBest->nHeight+1 <= 17280) // day 12
    {
		nSubsidy = 1600 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 17280 && pindexBest->nHeight+1 <= 18720) // day 13
    {
		nSubsidy = 1200 * COIN;
    } 
	else if(pindexBest->nHeight+1 > 18720 && pindexBest->nHeight+1 <= 20160) // day 14
    {
		nSubsidy = 950 * COIN;
    } 
...
#ifdef ENABLE_WALLET
// GopnikCoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("GopnikCoin-loadblk");
